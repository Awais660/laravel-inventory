                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-4 border rounded">
                                        ...
                                        @method('PUT')
                                            <div class="col-md-12">
                                                <input class="form-control mb-3" type="text" placeholder="Category" name="cname" value="{{$data['cname']}}"
                                                    aria-label="default input example">
                                                    <b><span id="cname" style="color:red"></span></b>
                                            </div>
                                            <div class="col-12">
                                                <textarea class="form-control" id="inputAddress" name="cdes"
                                                    placeholder="Description..." rows="3">{{$data['cdes']}}</textarea>
