			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
						...
						<div class="ms-auto">
							<div class="btn-group">
							<a href="{{url('permissions/create')}}"><button type="button" class="btn btn-primary">Add Permission</button></a>
							...
							<div class="table-responsive">
								<table id="example2" class="table table-striped table-bordered" style="width:100%">
									...
									<tbody>
										...
										<tr>
											<td>{{$fet['name']}}</td>
											<td><a class='btn btn-success' href="{{url('/permissions/'.$fet['id'].'/edit/')}}">Update</a></td>
