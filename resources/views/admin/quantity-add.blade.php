                ...
                <div class="page-content">
                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Quantity</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="ms-auto">
                    ...
                    <div class="row">
                        <div class="col-xl-9 mx-auto">
                            <h6 class="mb-0 text-uppercase">Add Quantity</h6>
                            <hr>
                            <div class="card">
                                <div class="card-body">
                                    <div class="p-4 border rounded">
                                        <form class="row g-3" id="data">
                                            <div class="col-md-12">
                                                <input class="form-control mb-3" type="text" placeholder="Quantity" name="qname"
