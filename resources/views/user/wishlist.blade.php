                            ...
                            <tr class="product-row">
                                <td>
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="{{url('assets/images/products/product-4.jpg')}}" alt="product">
                                        </a>
                                ...
                                <td>
                                    <h5 class="product-title">
                                        <a href="{{url('product')}}">Men Watch</a>
                                    </h5>
                                </td>
                                ...
                                <td class="action">
                                    <a href="{{url('ajax/product-quick-view.html')}}" class="btn btn-quickview mt-1 mt-md-0"
