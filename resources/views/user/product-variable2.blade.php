                            ...
                            <div class="product-slider-container">
                                ...
                                <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                    ...
                                    <div class="product-item">
                                        <img class="product-single-image" src="{{"../images/".$image}}" data-zoom-image="{{"../images/".$image}}" width="468" height="468" alt="product" />
                                    </div>
                                    @endforeach
                                    @endforeach
												@else
                        ...
                        <div class="col-lg-7 col-md-6 product-single-details">
                            ...
                            {{-- <div class="product-action">
                                ...
                                <!-- End .product-single-qty -->
                                    ...
                                    <input type="hidden" class="stock" name="stock" value="{{$pro->product_attrs[0]->stock}}">
                                    <input type="hidden" class="unit" name="unit" value="{{$pro->product_attrs[0]->unit}}">
                                    <input type="hidden" class="srp" name="srp" value="{{$pro->product_attrs[0]->srp}}">
                                    <input type="hidden" class="size" name="size" value="{{$pro->product_attrs[0]->size}}">
                                    <input type="hidden" class="color" name="color" value="{{$pro->product_attrs[0]->color}}">
                                    @php
													$image=unserialize($pro->product_attrs[0]->image);
												@endphp
                                    <input type="hidden" class="image" name="image" value="{{$image[0]}}">
                                    <input type="hidden" class="pcode" name="pcode" value="{{$pro->product_attrs[0]->pcode}}">

                                    @else

                                    <input type="hidden" class="stock" name="stock" value="{{$pro->product_attr->stock}}">
                                    <input type="hidden" class="unit" name="unit" value="{{$pro->product_attr->unit}}">
                                    <input type="hidden" class="srp" name="srp" value="{{$pro->product_attr->srp}}">
                                    @php
													$image=unserialize($pro->product_attr->image);
												@endphp
                                    <input type="hidden" class="image" name="image" value="{{$image[0]}}">
                                    <input type="hidden" class="pcode" name="pcode" value="{{$pro->product_attr->pcode}}">
                                    @endif
                                <a href="javascript:;" class="btn btn-dark add-cart mr-2" id="additem" title="Add to Cart">Add to
                                    Cart</a>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="product-size-content" role="tabpanel" aria-labelledby="product-tab-size">
                            <div class="product-size-content">
                                <div class="row">
                                    <div class="col-md-4">
                                        <img src="{{url('assets/images/products/single/body-shape.png')}}" alt="body shape" width="217" height="398">
                                    </div>
                                    <!-- End .col-md-4 -->
                ...
                <div class="products-section pt-0">
                    ...
                    <div class="products-slider owl-carousel owl-theme dots-top dots-small">
                        <div class="product-default">
                            <figure>
                                <a href="{{url('product')}}">
                                    <img src="{{url('assets/images/products/product-1.jpg')}}" width="280" height="280" alt="product">
                                    <img src="{{url('assets/images/products/product-1-2.jpg')}}" width="280" height="280" alt="product">
                                </a>
                                <div class="label-group">
                                    <div class="product-label label-hot">HOT</div>
...
if (!liElements2[index].classList.contains('active') ) {
  ...
  return htmlContent;
    ...
    $(document).on("click","#additem",function(stop){
                ...
                type:"POST",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
				data:{pid:id,pname:name,pdes:des,pstock:stock,punit:unit,psrp:srp,psize:size,pcolor:color,pimage:image,pcode:code},
				success:function(res){
					if(res==3){
						Swal.fire(
                       'Sorry',
