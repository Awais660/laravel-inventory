					...
					<div class="col-lg-9">
						<article class="post single">
							<div class="post-media">
								<img src="{{url('assets/images/blog/post-1.jpg')}}" alt="Post">
							</div><!-- End .post-media -->
							...
							<div class="post-body">
								...
								<div class="post-author">
									...
									<figure>
										<a href="#">
											<img src="{{url('assets/images/blog/author.jpg')}}" alt="author">
										</a>
									</figure>
							...
							<div class="owl-carousel owl-theme related-posts-carousel" data-owl-options="{
								...
								<article class="post">
									<div class="post-media zoom-effect">
										<a href="{{url('single')}}">
											<img src="{{url('assets/images/blog/related/post-1.jpg')}}" alt="Post">
										</a>
									</div><!-- End .post-media -->
									...
									<div class="post-body">
										...
										<h2 class="post-title">
											<a href="{{url('single')}}">Post Format - Image</a>
										</h2>
										...
										<div class="post-content">
											...
											<a href="{{url('single')}}" class="read-more">read more <i
								...
								<article class="post">
									<div class="post-media zoom-effect">
										<a href="{{url('single')}}">
											<img src="{{url('assets/images/blog/related/post-2.jpg')}}" alt="Post">
										</a>
									</div><!-- End .post-media -->
								...
								<article class="post">
									<div class="post-media zoom-effect">
										<a href="{{url('single')}}">
											<img src="{{url('assets/images/blog/related/post-3.jpg')}}" alt="Post">
										</a>
									</div><!-- End .post-media -->
							...
							<div class="widget">
								...
								<ul class="simple-post-list">
									<li>
										<div class="post-media">
											<a href="{{url('single')}}">
												<img src="{{url('assets/images/blog/widget/post-1')}}.jpg" alt="Post">
											</a>
										</div><!-- End .post-media -->
										<div class="post-info">
											<a href="{{url('single')}}">Post Format - Video</a>
											<div class="post-meta">
												April 08, 2018
											</div><!-- End .post-meta -->
										</div><!-- End .post-info -->
									...
									<li>
										<div class="post-media">
											<a href="{{url('single')}}">
												<img src="{{url('assets/images/blog/widget/post-2')}}.jpg" alt="Post">
											</a>
										</div><!-- End .post-media -->
										<div class="post-info">
											<a href="{{url('single')}}">Post Format - Image</a>
