				...
				<div class="container">
					<ol class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="{{url('user')}}"><i class="icon-home"></i></a>
						</li>
						...
						<div class="col-sm-6 col-lg-3">
							<div class="feature-box text-center">
								...
								<div class="feature-box-content">
									...
									<h5><a href="{{url('https://portotheme.com/cdn-cgi/l/email-protection')}}" class="__cf_email__" data-cfemail="067669747269467669747269726e636b632865696b">[email&#160;protected]</a></h5>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-lg-3">
