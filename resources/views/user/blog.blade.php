						...
						<div class="blog-section row">
							<div class="col-md-6 col-lg-4">
								<article class="post">
									<div class="post-media">
										<a href="{{url('single')}}">
											<img src="{{url('assets/images/blog/home/post-1.jpg')}}" alt="Post" width="225"
												height="280">
										</a>
										<div class="post-date">
							...
							<div class="col-md-6 col-lg-4">
								<article class="post">
									<div class="post-media">
										<a href="{{url('single')}}">
											<img src="{{url('assets/images/blog/home/post-2.jpg')}}" alt="Post" width="225"
												height="280">
										</a>
										<div class="post-date">
											<span class="day">26</span>
							...
							<div class="col-md-6 col-lg-4">
								<article class="post">
									<div class="post-media">
										<a href="{{url('single')}}">
											<img src="{{url('assets/images/blog/home/post-3.jpg')}}" alt="Post" width="225"
												height="280">
										</a>
										<div class="post-date">
											<span class="day">26</span>
									...
									<div class="post-body">
										<h2 class="post-title">
											<a href="{{url('single')}}">Etiam laoreet sem</a>
										</h2>
										<div class="post-content">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras non
												placerat mi.
							...
							<div class="col-md-6 col-lg-4">
								<article class="post">
									<div class="post-media">
										<a href="{{url('single')}}">
											<img src="{{url('assets/images/blog/home/post-4.jpg')}}" alt="Post" width="225"
												height="280">
										</a>
										<div class="post-date">
											<span class="day">26</span>
